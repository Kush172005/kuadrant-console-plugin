...
const APIProductForm: React.FC<APIProductFormProps> = ({
  ...
  const constructResource = (): APIProduct => {
    ...
    // Use the namespace from the existing object in edit mode, otherwise use the prop
    const resourceNamespace = obj?.metadata?.namespace ?? namespace;
  ...
  const isFormValid = (): boolean => {
    ...
    return (
      ...
      isValidResourceName &&
      formData.httpRoute?.name !== '' &&
      formData.httpRoute?.name !== undefined &&
      !yamlError
    );
  };
                ...
                <FormGroup label={t('Kubernetes resource name')} isRequired fieldId="resource-name">
                  ...
                  <FormHelperText>
                    <HelperText>
                      <HelperTextItem>
                        {t(
                          'Auto-generated from product name. Only lowercase, numbers, hyphens, and dots allowed.',
                        )}
                      </HelperTextItem>
                    </HelperText>
                  </FormHelperText>
            ...
            {(() => {
              ...
              return (
                <KuadrantCreateUpdate
                  model={getModelFromResource(resource)}
                  resource={resource}
